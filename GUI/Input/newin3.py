...
class MyPanel2 ( wx.Panel ):
	...
	def __init__( self, parent ):
		wx.Panel.__init__ ( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( 387,159 ), style = wx.TAB_TRAVERSAL )
		...
		self.lbl0 = wx.StaticText( self, wx.ID_ANY, u"کد شیفت", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.lbl0.Wrap( -1 )
		HS21.Add( self.lbl0, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
		
		self.fild0 = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0 )
		HS21.Add( self.fild0, 0, wx.ALL|wx.ALIGN_CENTER_VERTICAL, 5 )
	...
	def srshift( self, event ):
                data = sq.wxsqsel('employee.db','Shifts','totime ,fromtime ,Shiftname, Shiftid')
                fild_title=[u'کد شيفت',u'نام شيفت',u'از ساعت',u'تا ساعت']
		srch = wx.Dialog(self)
		pnlsr = sr.MyPanel1(srch,data,fild_title)
	...
	def Addshift( self, event ):
                ...
                inlist = sq.wxsqins('employee.db','Shifts','shiftid,shiftname,fromtime,totime',(f0,f1,f2,f3))
